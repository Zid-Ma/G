...
public:
    ...
    void InitializationFont()
    {
        ...
        //15
        {
            ...
            _lwh = vec3(80, 80, 0);
            _f = New_UI_Font("", _point, _lwh, 32, -1, NULL, "土豆", "白菜", "葱葱", "蒜苗", "韭菜", "镰刀");
            _f.textures[5] = Load_texture_image(Font::Load_FontToPNG("m", Path_Font + Font, "白菜", 32, _lwh.x, _lwh.y, &_f.length), _f.length, _lwh.x, _lwh.y, GL_RGBA);
            _f.point = _point;
            _f.lwh = _lwh;
            _f.function = NULL;
            _f.mod = -1;
        ...
        //17        
        {
            ...
            _lwh = vec3(120, 100, 0);
            _f = New_UI_Font("", _point, _lwh, 32, -1, NULL, "种植得分:", "", "", "", "", "");
            _f.point = _point;
            _f.lwh = _lwh;
            _f.function = NULL;
            _f.mod = -1;
...
private:
    ...
    void InitializationFont()
    {
        ...
        _lwh = vec3(150, 50, 0);
        _f = New_UI_Font("ChangeFPS", _point, _lwh, 32, -1, ChangeFPS, "跟随屏幕", "60", "144", "240", "不做限制", "");
        fonts.push_back(_f);
        //18
...
public:
  ...
  private:
      void Delete()
      {
          ...
          {
              Print::Line("删除场景数据时出错...(处于开发者模式时将显示错误信息)");
