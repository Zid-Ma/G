...
public:
	...
	void First()
	{
		if (first)
		{
			...
			model.push_back(ptr);
			ptr = new ModelX(Path_Model + "potato/土豆三X.txt");
			model.push_back(ptr);
			ptr = new ModelX(Path_Model + "potato/土豆四X.txt");
			model.push_back(ptr);
			ptr = new ModelX(Path_Model + "potato/土豆五X.txt");
			model.push_back(ptr);
			ptr = new ModelX(Path_Model + "potato/土豆六X.txt");
			model.push_back(ptr);
			stage = 0;
			stage_names[0] = "入土";
			stage_names[1] = "萌芽";
...
public:
	...
	void First()
	{
		if (first)
		{
			...
			model.push_back(ptr);
			ptr = new ModelX(Path_Model + "cabbage/白菜三X.txt");
			model.push_back(ptr);
			ptr = new ModelX(Path_Model + "cabbage/白菜四X.txt");
			model.push_back(ptr);
			ptr = new ModelX(Path_Model + "cabbage/白菜五X.txt");
			model.push_back(ptr);
			ptr = new ModelX(Path_Model + "cabbage/白菜六X.txt");
			model.push_back(ptr);
			stage = 0;
			stage_names[0] = "入土";
			stage_names[1] = "萌芽";
